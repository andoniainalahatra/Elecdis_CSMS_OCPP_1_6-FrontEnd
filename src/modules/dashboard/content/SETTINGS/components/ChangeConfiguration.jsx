            ...
            <div className='flex items-center w-1/2 bg-white rounded-md h-1/2 max-md:w-screen max-md:h-screen '>
                ...
                <div className='mx-auto border w-[80%] flex flex-col items-center space-y-5 p-5'>
                    ...
                    <div className='flex justify-center text-white md:space-x-2 max-md:flex-col'>
                        <button className='border rounded-md hover:ring-2 hover:ring-black h-[50px] w-[200px] bg-green-700 hover:bg-gray-700'>
                            Valider
                        </button>
                        <button className='border rounded-md hover:ring-2 hover:ring-black h-[50px] w-[200px] bg-red-700 hover:bg-gray-700'>
                            Annuler
                        </button>
                    </div>

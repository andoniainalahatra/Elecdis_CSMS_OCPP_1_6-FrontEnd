    ...
    <div className="bg-white shadow-lg rounded-lg p-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-blue-100 p-4 rounded-lg text-center">
          ...
          <p className="text-3xl font-semibold text-blue-500">${totalRevenue.toFixed(2)}</p>
        </div>

        <div className="bg-green-100 p-4 rounded-lg text-center">
          <h3 className="text-xl font-bold text-gray-800">Total Partners</h3>
          <p className="text-3xl font-semibold text-green-500">{totalPartners}</p>
        </div>
      </div>
    </div>
  );

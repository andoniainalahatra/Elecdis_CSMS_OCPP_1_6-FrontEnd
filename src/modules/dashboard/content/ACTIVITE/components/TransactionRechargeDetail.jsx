          ...
          <div className="w-full flex items-center justify-start flex-col gap-4 rounded-lg">
            <div className="w-full">
              ...
              <div className="grid grid-cols-2 gap-2 items-center">
                <IconWithText
                  Icon={FaUserAlt}
                  Value={dataObj ? dataObj.user_name : "null"}
                />
                <IconWithText
                  Icon={PiCardsFill}
                  Value={dataObj ? dataObj.rfid : "null"}
                />
              </div>
            </div>
            <div className="w-full">
              ...
              <IconWithText
                ...
                Value={dataObj ? dataObj.charge_point_id : "null"}
              />
              <IconWithText
                Icon={FaPlug}
                Value={dataObj ? dataObj.connector_id : "null"}
              />
              <div className="grid grid-cols-2 gap-2">
                <IconWithText
                  Icon={IoCalendarClear}
                  Value={dataObj ? takeOnlyDate(dataObj.start_time) : "null"}
                />
                <div className="flex p-2 bg-gray-200 rounded-lg justify-start items-center mb-3 gap-4">
                  ...
                  <div className="flex justify-start items-center gap-1">
                    <p className="text-[#637381] text-lg">
                      {dataObj ? takeOnlyTime(dataObj.start_time) : "null"}
                    </p>
                    <FaLongArrowAltRight color="#637381" size={12} />
                    <p className="text-[#637381] text-lg">
                      {dataObj ? takeOnlyTime(dataObj.end_time) : "null"}
                    </p>
                  </div>
                </div>
              </div>

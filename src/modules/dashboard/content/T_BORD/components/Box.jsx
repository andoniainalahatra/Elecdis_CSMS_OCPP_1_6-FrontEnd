  ...
  return (
    <div className="relative rounded-2xl px-[10px] py-[2vw] shadow-combined bg-[#ffffff] flex justify-center items-start gap-[2vw] 
      ...
      <div className="w-[20%] flex justify-center max-2xl:mt-[1vw] items-center relative">
        <div onClick={handleClick} className="w-full flex justify-center items-center relative">
          <FirstIcone color={color} className={`w-[3vw] h-[2.5vw] max-sm:invisible`} />
          <SecondIcone color={color} className={`max-sm:w-[32px] max-sm:h-[32px] w-[3vw] h-[2.5vw] absolute z-10 right-0 bottom-0 transform max-sm:relative translate-x-[20%] translate-y-[20%] opacity-100`} />
      ...
      <div className="w-[60%] flex flex-col gap-2">
        <div className="w-full flex justify-between items-center">
          {isLoading ? (
            ...
            <p onClick={handleClick} className="font-bold text-[4vw] sm:text-[2vw] md:text-[1.5vw] lg:text-[1vw] xl:text-[20px] text-[#212B36]">
        ...
        <p onClick={handleClick} className="text-[3vw] cursor-pointer sm:text-[2vw] md:text-[1.5vw] lg:text-[2vw] xl:text-[14px] font-bold text-[#919EAB]">
          {Title}
        </p>

...
const SelectList = React.forwardRef(({ id, label, value, type = "text", onChange }, forwardedRef) => {
    ...
    if (type === "select") {
        return (
            <div className="relative w-full">
                <Select
                    onValueChange={handleSelectChange} // Capture the selected value
                ...
                >
                    <SelectTrigger id="status" className={`mt-1 focus:ring-0 bg-transparent border focus:ring-offset-0 ${isFocused || selectValue ? "border-primaryChart" : "border-gray-300"}`}>

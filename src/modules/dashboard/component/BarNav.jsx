...
const BarNav = () => {
    ...
    return (
        <div className="w-[100%] absolute top-0  h-[8vh] bg-[#] ">
            ...
            <div className="flex items-center justify-between w-[100%] p-2 mx-auto h-[100%] text-white">
                ...
                <div className=" flex space-x-3">
                    <div className="relative text">
                        <BellAlertIcon className="w-[1.8rem]  h-[1.8rem] cursor-pointer text-gray-500" />
                        <span className=" absolute bg-red-600  h-[1.5rem] w-[1.5rem] text-center rounded-full -top-3 right-0
                         font-semibold border flex items-center justify-center  text-[13px]">6</span>
                    </div>
